...
def main():
    ...
    parser.add_argument('--negative-latency',
                    help='number of seconds to strip from template bank waveforms'
                         'in order to simulate early warning.'
                            'Default: 0',
                    default='0')
...
#    filter_templates=bool(arguments['filter_templates'])
    ...
    neglat_seconds=int(arguments['negative_latency'])
